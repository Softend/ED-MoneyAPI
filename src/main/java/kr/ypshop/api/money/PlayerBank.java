...
public abstract class PlayerBank {
     ...
     * @return 금액의 소지 여부
     */
    abstract boolean hasBalance(BigInteger balance) throws BankException;
     ...
     * @return 금액의 소지 여부
     */
    abstract boolean hasBalance(int balance) throws BankException;
     ...
     */
    abstract void withdraw(BigInteger balance) throws NotEnoughBalanceException;
     ...
     * @throws NotEnoughBalanceException 해당 객체에 충분한 금액이 없을 경우 발생합니다.
     */
    abstract void withdraw(int balance) throws NotEnoughBalanceException;

    /**
     * 객체에 balance 만큼의 금액을 입금합니다.
     * @param balance 입금 할 금액
     */
    abstract void deposit(BigInteger balance) throws BankException;

    /**
     * 객체에 balance 만큼의 금액을 입금합니다.
     * @param balance 입금 할 금액
     */
    abstract void deposit(int balance) throws BankException;

    /**
     * 객체의 금액을 balance 로 설정합니다.
     * @param balance 설정 할 금액
     */
    abstract void set(BigInteger balance) throws BankException;

    /**
     * 객체의 금액을 balance 로 설정합니다.
     * @param balance 설정 할 금액
     */
    abstract void set(int balance) throws BankException;

    /**
     * 객체가 현재 보유중인 금액을 반환합니다.
     * @return 현재 보유중인 금액
     */
    abstract BigInteger getBalance();
